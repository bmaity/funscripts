#Coursera Assignment3 chapter 4
...
is the actual data you need to process for the assignment
    ...
    Actual problem: Start at: http://py4e-data.dr-chuck.net/known_by_Zerah.html
...
for you to do the assignment without writing a Python program. But frankly with a little effort and patience you 
can overcome these attempts to make it a little harder to complete the assignment without writing a Python program. 
